/**
 * Tip-jar store product ids for Packing List — app-owned (NOT synced from the
...
export const TIP_PRODUCT_IDS = [
  'com.joshapproved.packinglist.tip.tier1',
  'com.joshapproved.packinglist.tip.tier2',
  'com.joshapproved.packinglist.tip.tier3',
  'com.joshapproved.packinglist.tip.tier4',
  'com.joshapproved.packinglist.tip.tier5',
] as const;
