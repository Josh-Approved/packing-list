...
export const APP_STRINGS = {
  ...
  detail: {
    ...
    assigneeHint: 'Tap to change who packs this.',
    sync: {
      connected: 'Connected',
      offline: 'Offline',
      syncing: 'Syncing…',
      trouble: 'Not syncing',
      hint: 'Shared trip sync. Tap to sync now.',
    },
  },
  gender: {
    female: 'Female',
