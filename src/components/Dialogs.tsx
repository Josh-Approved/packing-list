 ...
 * silently undefined on Android), so trip/packer/category management works
 * identically on both platforms. Studio tenet: functional parity is mandatory;
 * no OS-specific frameworks for core functionality.
 *
 * Styling mirrors the canonical ReviewModal (same scrim/card tokens) so every
 * dialog in the app reads as a sibling. Reduced motion collapses the present
 * animation to none (canon § Accessibility, WCAG 2.2 AA).
 *
